...
const simpleMessage = <div
  style={{
    alignItems: 'center',
    backgroundImage: `url("https://degen-frame.poidh.xyz//bg-poidh.png")`,
...
>
  <div style={{
    ...
    position: "absolute",
    top: 0,
    backgroundImage: `url("https://degen-frame.poidh.xyz//logo-poidh.png")`,
  }}
  >
  </div>
</div >
...
app.frame('/', (c) => {
  return c.res({
    action: '/bountytitle',
    image: "https://degen-frame.poidh.xyz//screen-1.png",
    intents: [
...
app.frame('/share', (c) => {
  ...
  return c.res({
    ...
    intents: [
      ...
      !&embeds[]=https://degen-frame.poidh.xyz//api//bounty/${c.transactionId}`}>Share</Button.Link>,
